...
import static me.drexhd.itsmine.Messages.header;
import static me.drexhd.itsmine.util.EntityUtil.*;
...
public class EntitiesCommand {
    public static void register(LiteralArgumentBuilder<ServerCommandSource> command) {
        ...
        claim.executes(context -> execute(context, ClaimManager.INSTANCE.getClaim(context.getSource().getPlayer().getUuid(), StringArgumentType.getString(context, "claim"))));
        entity.then(claim);
        command.then(entity);
    }
